...
@Component({
  ...
  providers: [CepPipe,FormataDataPipe,FormataEstadoCivilPipe,CelularPipe,TelefonePipe,
    DesmascaraCEPPipe,DesmascaraCPFPipe,DesmascaraTelefonePipe,DesmascaraCelularPipe]
})
export class CadastroComponent implements OnInit {
  ...
  buscarPorCPF(){
    ...
    cpf = this.cpfDesmasc.transform(cpf);

    this.service.getPorCPF(cpf).subscribe(proprietario => {
  ...
  onSubmit(){
    ...
    if(this.formulario.valid){
      ...
      this.service.cadastrar(this.prop).subscribe(res => {
